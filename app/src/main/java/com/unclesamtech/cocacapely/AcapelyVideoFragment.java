 ...
 * Use the {@link AcapelyVideoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AcapelyVideoFragment extends Fragment {
     ...
     * @return A new instance of fragment AcapelyVideoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AcapelyVideoFragment newInstance(String param1, String param2) {
        AcapelyVideoFragment fragment = new AcapelyVideoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            v = inflater.inflate(R.layout.fragment_acapely_video, container, false);
            ...
            recyclerView = v.findViewById(R.id.rv_video_acap);


            playListAdapter = new AcapelyMediaAdapter(rhemaPlayList);
            RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getContext(),2);
            recyclerView.setLayoutManager(mLayoutManager);
            recyclerView.addItemDecoration(new AcapelyItemDecoration(2, dpToPx(10), true));
            ...
            recyclerView.addOnItemTouchListener(new AcapelyItemTouchListener(getContext(), recyclerView, new AcapelyItemTouchListener.ClickListener() {
                ...
                public void onClick(View view, int position) {
                    ...
                    pushPlayListId(acapelyModel.getPlaylist_id(),"AcapelyPlayId",MODE_PRIVATE,"AcapelyPlayPrefId");
            ...
            getFab(R.id.fab_create_playlist).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    pushPoster(posterName,"acap_post_name_key",MODE_PRIVATE,"acap_post_name_pref_key");
                    startActivity(new Intent(getContext(), AcapelyCreateVideoPlaylist.class));
                }
            });
        } catch (Exception e) {
    ...
    private void popVid(){
        rhemaPlayList.add(new AcapelyMediaModel("Media Title","D4BoanknDFbIfArDYC6uYpDnphbqhO6I","2:34","","juggt56vhjjj"));
        rhemaPlayList.add(new AcapelyMediaModel("Music Title","1jpah7BtiMc4EzLqs_ZPgJpUsuBSzXBf","3:34","","juggt56vhjjj"));
        rhemaPlayList.add(new AcapelyMediaModel("Video Title","Phb5GPf3Rfc944An2iDh_kTHkrKhoCED","8:34","","juggt56vhjjj"));
        rhemaPlayList.add(new AcapelyMediaModel("Acapella Title","A6SWXeYAHgFlY5T7-A6HMF8W6GAGOVqZ","9:34","","juggt56vhjjj"));
    ...
    public void pushPlayListId( String value,String key , int mode, String prefkey){
        SharedPreferences shPref = getContext().getSharedPreferences(prefkey,mode);
        SharedPreferences.Editor edt = shPref.edit();
        edt.putString(key,value);
        edt.apply();
    ...
    private void retrVideoPlayList(){
        if(networkInfo != null && networkInfo.isConnectedOrConnecting() && networkInfo.isConnected()) {
            ...
            rhemaCollRef.whereEqualTo("playlistType","Video Playlist").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                @Override
