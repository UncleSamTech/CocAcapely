...
public class AcapelyCreateMusicPlaylist extends AppCompatActivity {
    private View v;
    ...
    Context c = AcapelyCreateMusicPlaylist.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acapely_create_music_playlist);
        try{

            actionBar = getSupportActionBar();
            if(actionBar != null){
                actionBar.setTitle("Music Playlist");
            }
            else{
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                try{
                                    if(!TextUtils.isEmpty(getUserId()) && !TextUtils.isEmpty(poster_name) && !TextUtils.isEmpty(playlistTitle) && !TextUtils.isEmpty(downloadUrl) && !TextUtils.isEmpty(createdTime) && !TextUtils.isEmpty(playlistId)){
                                        regPlayList(playlistTitle,playlistId,poster_name,downloadUrl,getUserId(),createdTime,"Music Playlist");
